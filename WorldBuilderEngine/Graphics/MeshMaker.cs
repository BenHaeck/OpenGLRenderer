...
namespace MBEngine {
	...
	public class MeshMaker: IDisposable {
		...
		public MeshMaker (int vertexNum, int indexNumber, BufferUsageHint usage = BufferUsageHint.DynamicDraw) {
			...
			GL.BufferData(BufferTarget.ArrayBuffer, sizeof(float) * verteces.Length, verteces, usage);
